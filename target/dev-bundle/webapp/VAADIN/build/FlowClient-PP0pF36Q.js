  ...
  (function() {
    ...
    function fm(a, b2) {
      ...
      if (c2) {
        ...
        !c2 ? Xj && PC($wnd.console, "There is no element addressed by the path '" + b2 + "'") : Xj && PC($wnd.console, "The node addressed by path " + b2 + BH);
      return null;
    }
    function Ar(b2) {
      var c2, d2;
