import { $ as $$1, M as Mi, h as al, b as _$1, Y as Ya, a as _s, l as fe$1, J as Jt, n as _l, o as ce$1, Q as Qa, D as Dl, q as fl, z as zi, _ as _r, s as Xe, C as Cl, v as vl, A, V as Vl, R as Rl, E as El } from "./indexhtml-Dqry5TTA.js";
import { g as g$1, h } from "./state-D4MdSqrt-CdhCBVgr.js";
import { p, y } from "./overlay-monkeypatch-B_ui42---tDRLhERt.js";
import { r as r$1 } from "./icons-RmKgnsAR-BtD9KKQm.js";
import { h as h$1 } from "./unsafe-html-C-xRxXSj-LQm6kEP2.js";
import { K } from "./react-utils-DFD62MFY-DV-Nu30T.js";
import { showNotification as N, dismissNotification as c } from "./copilot-notification-BtXneIoV-XQmR8j5y.js";
/**
 * @license
...
var de = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, b = (e, t, n, o) => {
  for (var i = o > 1 ? void 0 : o ? ce(t, n) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (o ? s(t, n, i) : s(i)) || i);
  return o && i && de(t, n, i), i;
};
...
let m = class extends _s {
  ...
  mouseEnterListener(e) {
    this.closingForcefully || _$1.sectionPanelResizing || (this.opened = true);
  }
  render() {
    return _r`
...
var he = Object.defineProperty, ge = Object.getOwnPropertyDescriptor, j = (e, t, n, o) => {
  for (var i = o > 1 ? void 0 : o ? ge(t, n) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (o ? s(t, n, i) : s(i)) || i);
  return o && i && he(t, n, i), i;
};
...
class pe {
  ...
  adjust(t, n, o, i, r) {
    let s, d, h2, w;
    const y2 = document.documentElement.getBoundingClientRect().width, x = document.documentElement.getBoundingClientRect().height;
    return (i + n) / 2 < y2 / 2 ? (t.style.setProperty("--left", `${n}px`), t.style.setProperty("--right", ""), w = void 0, s = Math.max(0, n)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${y2 - i}px`), s = void 0, w = Math.max(0, y2 - i)), (o + r) / 2 < x / 2 ? (t.style.setProperty("--top", `${o}px`), t.style.setProperty("--bottom", ""), h2 = void 0, d = Math.max(0, o)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${x - r}px`), d = void 0, h2 = Math.max(0, x - r)), {
      left: s,
      right: w,
      top: d,
      bottom: h2
...
const f = new pe();
var ue = Object.defineProperty, ve = Object.getOwnPropertyDescriptor, q = (e, t, n, o) => {
  for (var i = o > 1 ? void 0 : o ? ve(t, n) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (o ? s(t, n, i) : s(i)) || i);
  return o && i && ue(t, n, i), i;
};
const fe = 8;
  ...
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = false, this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: n } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(n - this.initialMouseDownPosition.y) > fe;
      }
...
var me = Object.defineProperty, be = Object.getOwnPropertyDescriptor, E = (e, t, n, o) => {
  for (var i = o > 1 ? void 0 : o ? be(t, n) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (o ? s(t, n, i) : s(i)) || i);
  return o && i && me(t, n, i), i;
};
const g = "resize-dir", B = "floating-resizing-active";
let I = class extends _s {
  constructor() {
    super(...arguments), this.panelTag = "", this.floatingResizingStarted = false, this.resizingInDrawerStarted = false, this.toggling = false, this.rectangleBeforeResizing = null, this.floatingResizeHandlerMouseMoveListener = (e) => {
      if (!this.panelInfo?.floating || this.floatingResizingStarted || !this.panelInfo?.expanded)
        return;
      const t = this.getBoundingClientRect(), n = Math.abs(e.clientX - t.x), o = Math.abs(t.x + t.width - e.clientX), i = Math.abs(e.clientY - t.y), r = Math.abs(t.y + t.height - e.clientY), s = 16;
      let d = "";
      if (n < s ? i < s ? (d = "nw-resize", this.setAttribute(g, "top left")) : r < s ? (d = "sw-resize", this.setAttribute(g, "bottom left")) : (d = "col-resize", this.setAttribute(g, "left")) : o < s ? i < s ? (d = "ne-resize", this.setAttribute(g, "top right")) : r < s ? (d = "se-resize", this.setAttribute(g, "bottom right")) : (d = "col-resize", this.setAttribute(g, "right")) : r < s ? (d = "row-resize", this.setAttribute(g, "bottom")) : i < s && (d = "row-resize", this.setAttribute(g, "top")), d !== "") {
        const h2 = window.getComputedStyle(this), w = Number.parseInt(h2.borderTopWidth, 10), y2 = Number.parseInt(h2.borderTopWidth, 10), x = Number.parseInt(h2.borderLeftWidth, 10), V = Number.parseInt(h2.borderRightWidth, 10);
        this.rectangleBeforeResizing = this.getBoundingClientRect(), this.rectangleBeforeResizing.width -= x + V, this.rectangleBeforeResizing.height -= w + y2, this.style.setProperty("--resize-cursor", d);
      } else
      ...
      n && n > Number.parseFloat(window.getComputedStyle(this).getPropertyValue("--min-width")) && (this.style.setProperty(`--${e}`, `${t}px`), this.style.setProperty("width", `${n}px`)), o && o > Number.parseFloat(window.getComputedStyle(this).getPropertyValue("--header-height")) && (this.style.setProperty(`--${e}`, `${t}px`), this.style.setProperty("height", `${o}px`));
      ...
      const { width: t, height: n } = this.getBoundingClientRect(), { left: o, top: i, bottom: r, right: s } = f.anchor(this), d = window.getComputedStyle(this), h2 = Number.parseInt(d.borderTopWidth, 10), w = Number.parseInt(d.borderTopWidth, 10), y2 = Number.parseInt(d.borderLeftWidth, 10), x = Number.parseInt(d.borderRightWidth, 10);
      ...
      }), this.style.removeProperty("width"), this.style.removeProperty("height"), this.setCssSizePositionProperties(), this.toggleAttribute("dragging", false);
  ...
  getPopupButtonIcon() {
    return this.panelInfo ? this.panelInfo.panel === void 0 ? r$1.close : this.panelInfo.floating ? this.panelInfo.panel === "bottom" ? r$1.dockBottom : this.panelInfo.panel === "left" ? r$1.dockLeft : this.panelInfo.panel === "right" ? r$1.dockRight : A : r$1.popup : A;
  }
  renderActions() {
...
E([
  h()
], I.prototype, "panelTag", 2);
E([
  p(".drag-handle")
], I.prototype, "headerDraggableArea", 2);
E([
  p("#content")
], I.prototype, "contentArea", 2);
E([
  p('[part="drawer-resize"]')
], I.prototype, "drawerResizeElement", 2);
I = E([
