import { E as El, J as Jt, M as Mi, _ as _r, O as Ol, U as Ui, G as Ga, a as _s, $ as $$1, S as Sr, Y as Ya } from "./indexhtml-Dqry5TTA.js";
...
var b = Object.defineProperty, _ = Object.getOwnPropertyDescriptor, h = (e, t, a, o2) => {
...
let r = class extends o {
  ...
  handleLogEventData(e) {
    this.log(
      ...
      e.details,
      e.link,
      El(e.expandedMessage),
      El(e.expandedDetails),
      e.id
    );
  }
  activate() {
  ...
  updateLog(e) {
    ...
    Object.assign(t, e), Ga(t.expandedDetails) && (t.expandedDetails = El(t.expandedDetails)), this.requestUpdate();
  }
  toggleExpanded(e) {
